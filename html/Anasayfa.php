  ...
  <body>
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav me-auto mb-2 mb-md-0">
              ...
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="Memleketim.html">Memleketim</a>
              </li>
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="Takimimiz.html">Takımımız</a>
              </li>
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="Egitim.html">Eğitim Hayatım</a>
              </li>
              <li class="nav-item">
    ...
    <main>
      ...
      <div class="container">
        ...
        <p id="kim">
          &emsp;
          <strong>26 Kasım 2002</strong> tarihinde <strong>İstanbul</strong>' da doğdum. Hayatımın büyük bölümünü İstanbul' da geçirdim. <a href="Memleketim.html" target="_blank">Memleketim</a> <strong>Kayseri</strong>.
          Şuanda <strong>Sakarya Üniversitesi Bilgisayar Mühendisliği</strong> bölümünde eğitim görmekteyim.
          <br>
          &emsp;
          Çeşitli <a href="Hobilerim.html" target="_blank">Hobilerim</a> var. Futbol ve Basketbol önde olmak üzere sporu çok severim. Sadece uygulama olarak değil izlemesini ve takip etmesini de severim. Bilgisayar kullanmayı ve bilgisayarda işlemler yapmayı severim.
